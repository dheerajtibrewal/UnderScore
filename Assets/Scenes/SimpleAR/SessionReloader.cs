...
public class SessionReloader : MonoBehaviour
{
   ...
   // public Button resetButton;
    public PlaceOnPlane ToDestroyGame;
    public Test1AutoPlaceItem ToDestroyAnother;
    ...
    IEnumerator DoReload()
    {
        ...
        Destroy(ToDestroyGame.spawnedObject);
        Destroy(ToDestroyAnother.ItemPlacedController.GetGameObjectToPlace());
        yield return null;
